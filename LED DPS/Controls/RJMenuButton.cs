...
namespace LED_DPS.RJControls
{
    public class RJMenuButton : IconButton
    {
        ...
        //Static Fields
        private static readonly Color deactivateItemsColor = Color.White;//Sets or Gets Icon and text color when the menu button is deactivated
        private static readonly Color activateForeColor = Color.Black;//Sets or gets Text Color when menu button is activated
        private static readonly Color activateBackColor = Color.FromArgb(248, 171, 124);//Sets or gets back Color when menu button is activated and dropdown menu is displayed
        ...
        public object TabPages { get; internal set; }
        #endregion

        #region -> Private methods
        public void Activate(ChildForm guestForm)
        {//-> Normal Menu button
            ///<summary>
        ...
        public void Activate(ChildForm guestForm, ToolStripMenuItem menuItem)
        ...
        {//Activate / highlight menu button
            ...
            {//If the button does not have an associated form yet (This condition to not reactivate the button  
             //already has an associated form, therefore the button has already been activated previously)
                ...
                this.ForeColor = deactivateItemsColor;//set menu button text color 
        ...
        private void ShowDropdownMenu()
        {
            ...
            {
                LMessageBox.Show("An error has occurred\n" + ex.ToString());
            }
        }
        ...
        private void ActivateMenuItem(ChildForm guestForm, ToolStripMenuItem menuItem)
        { //Activate / highlight MenuItem
            ...
            //Set Menu Item Icon Color=ATENÇÃO----------------------------------------------------------------------
            if (UIAppearance.Style == UIStyle.Supernova)
        ...
        private void DropdownMenu_VisibleChanged(object sender, EventArgs e)
        {
            ...
            if (!DesignMode)//Run this when not in design mode
            {
                if (dropdownMenu.Visible)//If the dropdown menu was displayed
                {
                    ...
                    this.BackColor = RJColors.SideMenuColor;//Set active back color
                    if (this.Width > 100)//if width is greater than 100, i.e. side menu is expanded,
