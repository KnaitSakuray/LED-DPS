...
namespace LED_DPS.RJControls
{
    public class RJRadioButton : RadioButton
    {
        ...
        private void ApplyApperanceSettings()
        {
            if (customizable == false)
            {
                ...
                if (UIAppearance.Theme == UITheme.Light)
                    fillColor = LED_DPS.Utils.ColorEditor.Lighten(UIAppearance.BackgroundColor, 15);
                else fillColor = LED_DPS.Utils.ColorEditor.Darken(UIAppearance.BackgroundColor, 3);
            }
        }
        #endregion
        ...
        {// This method takes care of completely overriding the paint and drawing a new control with a custom appearance.
            ...
            int rbSize = 22; // Size of the radio button.
            int rbCheckSize = 14; // Size of the radio button check icon.
            ...
            {
                if (UIAppearance.Theme == UITheme.Light)
                fillColor = LED_DPS.Utils.ColorEditor.Lighten(this.Parent.BackColor, 10);
                else fillColor = LED_DPS.Utils.ColorEditor.Darken(this.Parent.BackColor, 3);
            }
