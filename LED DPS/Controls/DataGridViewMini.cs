...
namespace LED_DPS.Controls
{
    public class DataGridViewMini : DataGridView
    {
        #region -> Fields
        ...
        public DataGridViewMini()
        {
            ...
            this.BackgroundColor = RJColors.Petunia;
            ...
            ColumnHeaderStyle.BackColor = Color.Orange;
            ColumnHeaderStyle.Font = new Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point, ((byte)(0)));
            ...
            RowHeaderStyle.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point, ((byte)(0)));
            ...
            RowStyle.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point, ((byte)(0)));
        ...
        public bool AlternatingRowsColorApply
        {
            ...
            set
            {
                ...
                if (value == false) // If the value is false, restore the default color (RJColors.Empty)
                {
            ...
            if (customizable == false) // if not customizable, apply appearance settings.
            {
                if (UIAppearance.Theme == UITheme.Dark) // If the theme is dark, set the following properties
                {
                    ...
                    if (isAlternatingRowsColor) // If color alternate rows, set a color for the color of alternate rows
                    {
                        ...
                        SelectionTextColor = Color.White; // Selection text RJColors.
                    }
                    else // Normal row color
                    {
                        ...
                        SelectionTextColor = UIAppearance.PrimaryTextColor; // Selection text RJColors.
                    }
                ...
                else // If the topic is clear, set the following properties
                {
                    ...
                    else // Normal row color
                    {
                        ...
                        SelectionTextColor = UIAppearance.TextColor; // Selection text RJColors.
                    }
                }
            }
        }
