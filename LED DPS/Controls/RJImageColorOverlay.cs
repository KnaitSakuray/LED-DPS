...
namespace LED_DPS.RJControls
{
    public class RJImageColorOverlay : Panel
    {
        ...
        {// Apply the appearance settings to the control
            ...
            {
                overlayColor = LED_DPS.Settings.UIAppearance.StyleColor;
            }
        }
        ...
        {// Occurs when the control is redrawn
            ...
            using (var brush = new SolidBrush(Color.FromArgb(alpha, overlayColor)))
            {
                ...
                LED_DPS.Utils.RoundedControl.RegionAndSmoothed(this, borderRadius, graph); // Apply Rounded Corners + border Smoothing.
            }
        }
        #endregion
