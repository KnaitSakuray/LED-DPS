...
namespace LED_DPS.Forms
{
    public class ChildForm : BaseForm
    {
        ...
        private void InitializeItems()
        {
            ...
            btnFormIcon.IconChar = FontAwesome.Sharp.IconChar.Windows;
        ...
        {//When the form options dropdown is shown or hidden
            ...
            {//keep button highlighted and set icon to options list                
                btnFormIcon.BackColor = Utils.ColorEditor.Darken(btnFormIcon.BackColor, 15);
        ...
        {//Show the form help message
            if (helpMessage == "" || helpMessage == null)
                LMessageBox.Show("Entrar em contato com TI, em caso de duvidas", "Aviso");
            else
                LMessageBox.Show(helpMessage, "Quick Help");
        }
