...
{
    public partial class LMessageForm : Form
    {
        /// <summary>
        ...
        public LMessageForm(string text, string caption,
        ...
        {//load theme settings
            ...
            else
            {
                ...
                this.pnlButtons.BackColor = LED_DPS.Utils.ColorEditor.Darken(RJColors.DarkBackground, 3);//Set buttons panel backcolor
                this.lblMessageText.ForeColor = LED_DPS.Utils.ColorEditor.Lighten(UIAppearance.TextColor, 12);
            }
        ...
        private void LMessageForm_Load(object sender, EventArgs e)
        {
