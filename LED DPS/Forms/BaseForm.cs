...
namespace LED_DPS.Forms
{
    public partial class BaseForm : Form
    {
        ...
        public BaseForm()
        {
            ...
            btnClose.Image = Resources.CloseWhite;
            ...
            btnMaximize.Image = Resources.MaximizeWhite;
            ...
            btnMinimize.Image = Resources.MinimizeWhite;
            ...
            miSnapLeft.Text = "Fixar a esquerda";
            ...
            miSnapRight.Text = "Fixar a Direita";
            ...
            miExitSnap.Text = "Sair da Janela";
            ...
            if (isPrimaryForm)//If it is a primary form (e.g LoginForm and MainForm)
            {
                if (UIAppearance.Style == UIStyle.Supernova && UIAppearance.Theme == UITheme.Light) //If the style is supernova and the theme is light: Sets the icon to a dark color
                {
                    if (this.WindowState == FormWindowState.Normal)
                        btnMaximize.Image = Resources.MaximizeDark;
                    else
                        btnMaximize.Image = Resources.RestoreDark;
                }
                else //If it is any other theme or style: Sets the icon to a light color
                {
                    if (this.WindowState == FormWindowState.Normal)
                        ...
                        btnMaximize.Image = Resources.RestoreWhite;
                }
            }
        ...
        private void ApplyAppearanceSettings()
        {
            if (UIAppearance.Style == UIStyle.Supernova)//if the style is supernova
            {
                ...
                if (isPrimaryForm)
                {
                    ...
                    {
                        this.btnClose.Image = Resources.CloseDark;
                        this.btnMaximize.Image = Resources.MaximizeDark;
                        this.btnMinimize.Image = Resources.MinimizeDark;
                    }
                }
            }
        }
        ...
        protected virtual void CloseWindow()
        {
            ...
            {
                var result = LMessageBox.Show("Você tem certeza que deseja fechar o sistema?", "Aviso", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation);
        ...
        {
            if (isPrimaryForm && UIAppearance.Style == UIStyle.Supernova && UIAppearance.Theme == UITheme.Light)
                btnMinimize.Image = Resources.MinimizeDark;
        }
        ...
        {
            if (isPrimaryForm && UIAppearance.Style == UIStyle.Supernova && UIAppearance.Theme == UITheme.Light)
                btnClose.Image = Resources.CloseDark;
        }
