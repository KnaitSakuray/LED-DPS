...
namespace LED_DPS.Utils
{
    public static class RJColors
    {
        ...
        //-> RJColors--AQUIIII
        public static readonly Color SideMenuColor = Color.FromArgb(255, 178, 91);
        public static readonly Color DefaultFormBorderColor = Color.FromArgb(111, 106, 143);

        // Style Colors 
        public static readonly Color Axolotl = Color.FromArgb(248, 112, 171);//orange claro
        public static readonly Color FireOpal = Color.FromArgb(245, 124, 37);//orange escuro
        ...
        public static readonly Color Lisianthus = Color.FromArgb(248, 112, 171);//orange claro
        //public static readonly Color Neptune = Color.FromArgb(83, 97, 212);
        public static readonly Color Neptune = Color.FromArgb(245, 124, 37);//orange escuro
        public static readonly Color Petunia = Color.FromArgb(255, 128, 0);//orange
        public static readonly Color Ruby = Color.FromArgb(224, 40, 67);
        public static readonly Color Sky = Color.FromArgb(90, 146, 246);//suspeito
        public static readonly Color Spinel = Color.FromArgb(251, 111, 126);
        // Fantasy Color Scheme   
        public static readonly Color FantasyColorScheme1 = Color.FromArgb(169, 169, 169);
        ...
        public static readonly Color DarkBackground = Color.FromArgb(240, 245, 249);
        public static readonly Color DarkItemBackground = Color.FromArgb(250, 252, 253);
        public static readonly Color DarkActiveBackground = Color.FromArgb(231, 238, 246);
        public static readonly Color DarkTextColor = Color.FromArgb(132, 129, 132);
